...
export function OptimizedImage({
  ...
  return (
    <div className="relative w-full h-full overflow-hidden rounded-lg">
      ...
      {!isLogo && (
        <div
          className={`absolute inset-0 bg-gray-100 dark:bg-gray-800 transition-opacity duration-500 z-10 ${isLoading ? "opacity-100" : "opacity-0 pointer-events-none"
            }`}
        />
      )}
      ...
      {fill ? (
        <Image
          ...
          className={`${className} ${!isLogo && isLoading ? "scale-100 opacity-0" : "scale-100 opacity-100"
