      ...
      <Link href={`/post/${post.id}`}>
        <CardContent className="p-7">
          <div className="flex flex-col space-y-4">
            ...
            {/* Title: Large & Bold */}
            <h2 className="text-[22px] font-bold text-foreground leading-[1.35] tracking-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
              {post.title}
            </h2>

            {/* Description */}
            <p className="text-[15px] text-muted-foreground/75 leading-[1.6] line-clamp-2">
              {post.description}
            </p>
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center gap-2">
                {post.categories?.slice(0, 2).map((cat) => (
                  <span
                    key={cat}
                    className="px-3 py-1.5 bg-blue-50 dark:bg-blue-950/30 text-[11px] font-semibold rounded-lg text-blue-600 dark:text-blue-400 uppercase tracking-wide hover:bg-blue-100 dark:hover:bg-blue-950/50 transition-colors"
                  >
                    {cat}
                  </span>
                ))}
              ...
              <div className="flex items-center space-x-1.5">
                <button className="p-2 text-muted-foreground/60 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/30 rounded-lg transition-colors">
