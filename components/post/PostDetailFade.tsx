            ...
            <div className="max-w-[1600px] mx-auto px-4 lg:px-8 py-4 lg:py-8">
              ...
              <Card className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                <CardContent className="p-0">
                  ...
                  {/* Hero Image Section */}
                  <div className="px-5 sm:px-7 lg:px-10">
                    <div className={`relative w-full aspect-video overflow-hidden rounded-xl ${post.thumbnail ? '' : 'bg-gradient-to-br from-[#2665ff] via-[#2452db] to-[#1b3dbe]'}`}>
                      {post.thumbnail ? (
                        <OptimizedImage
                          src={post.thumbnail}
                          alt={post.title}
                  ...
                  <div className="px-5 sm:px-7 lg:px-10 py-7">
                    {/* AI Summary Header + View Original */}
                    <div className="flex items-center justify-between mb-7">
                      ...
                      {post.url && (
                        <a
                          ...
                          className="group inline-flex items-center gap-1.5 text-[12px] font-medium text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"
                        >
                          <span>원본 보기</span>
